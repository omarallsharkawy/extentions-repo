...
class Hentaijk :
    ...
    override fun popularAnimeSelector(): String = "div.card:has(a[href])"
    ...
    override fun popularAnimeFromElement(element: Element): SAnime {
        ...
        anime.thumbnail_url = element.selectFirst("img.card-img-top, .card-img img, img")
            ?.attr("src")
        anime.description = element.selectFirst(".card-synopsis")?.text().orEmpty()
        return anime
    }
