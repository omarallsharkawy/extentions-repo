...
class Kayoanime :
    ...
    override fun popularAnimeRequest(page: Int): Request = if (page == 1) {
        ...
        layout = ""
        settings = ""
        currentReferer = "$baseUrl/category/ongoing-anime/"
    ...
    override fun popularAnimeSelector(): String = "#posts-container > li.post-item"

    override fun popularAnimeFromElement(element: Element): SAnime = SAnime.create().apply {
        setUrlWithoutDomain(element.selectFirst("a")!!.attr("href"))
        val img = element.selectFirst("img")
        thumbnail_url = img?.attr("data-src")?.takeIf { it.isNotBlank() && !it.startsWith("data:") }
            ?: img?.attr("src")?.takeIf { it.isNotBlank() && !it.startsWith("data:") }
            ?: ""
        title = element.selectFirst("h2.post-title")!!.text().substringBefore(" Episode")
    }

    override fun popularAnimeNextPageSelector(): String = "div.pages-nav > a.load-more-button, div.pages-nav > a#load-more-archives"
    ...
    override fun searchAnimeRequest(page: Int, query: String, filters: AnimeFilterList): Request {
        return if (page == 1) {
            ...
            return when {
                ...
                subPageFilter != null && subPageFilter.state != 0 -> {
    ...
    private class SubPageFilter :
        UriPartFilter(
            ...
            arrayOf(
                ...
                Pair("Ongoing Anime", "/category/ongoing-anime/"),
            ),
        )
    ...
    private class GenreFilter :
        UriPartFilter(
            ...
            arrayOf(
                ...
                Pair("Supernatural", "/category/supernatural/"),
            ),
        )
