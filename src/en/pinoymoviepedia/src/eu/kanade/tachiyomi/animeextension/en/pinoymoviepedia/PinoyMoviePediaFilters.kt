...
object PinoyMoviePediaFilters {
    ...
    private inline fun <reified R> AnimeFilterList.getFirstOrNull(): R? = firstOrNull { it is R } as? R

    private inline fun <reified R> AnimeFilterList.asUriPart(): String = getFirstOrNull<R>()?.let {
