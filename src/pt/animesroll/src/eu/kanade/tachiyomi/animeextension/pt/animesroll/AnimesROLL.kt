...
class AnimesROLL :
    ...
    // ============================== Popular ===============================
    // Site moved from anroll.tv → anroll.plus; list path is /anime/ (singular).
    override fun popularAnimeSelector() = "article.item div.poster"
    override fun popularAnimeRequest(page: Int) = GET("$baseUrl/anime/page/$page", headers)
    override fun popularAnimeNextPageSelector() = "div.resppages a span.icon-chevron-right"

    // =============================== Latest ===============================
    // Default DooPlay pt-BR path is already "episodio" (singular).
