...
class NyaaTorrent(extName: String, private val extURL: String, private val extId: Int) :
    ...
    private val animeNextPageSelector = "ul.pagination li:not(.disabled) a[rel='next'], ul.pagination li.next:not(.disabled) a"
    ...
    override suspend fun getSearchAnime(page: Int, query: String, filters: AnimeFilterList): AnimesPage {
        ...
        if (query.startsWith(PREFIX_SEARCH)) {
            ...
            return client.newCall(GET("$baseUrl/view/$id"))
                .awaitSuccess()
