...
class CloudflareInterceptor(
    ...
    companion object {
        ...
        /**
         * Fallback User-Agent when the request carries none.
         *
         * Prefer an **Android Chrome** shape: desktop Windows UA on Android
         * WebView makes Cloudflare “Verifying you are human” hang forever.
         * Callers that already set User-Agent on the request win (see
         * requestHeaders.putIfAbsent). Prefer the **app** NetworkHelper CF
         * interceptor over this library when available.
         */
