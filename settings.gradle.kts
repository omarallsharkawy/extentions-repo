...
val targetModules = listOf(
    "ar:aflamk1", "ar:anime4up", "ar:animerco", "ar:arabshentai", "ar:arabseed",
    ...
    "all:rouvideo", "all:sextb", "all:streamingcommunity", "all:supjav", "all:supjav2", "all:xnxx", "all:xvideos"
)
